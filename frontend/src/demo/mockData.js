export const CLIENTI = [
  { id: 'c1', ragioneSociale: 'Rossi Mario', codiceFiscale: 'RSSMRA80A01H501U', partitaIva: '12345678901', email: 'mario.rossi@email.it', telefono: '02 1234567', tipologiaCliente: 'persona_fisica', categoriaAnagrafica: 'fiscale', regimeFiscale: 'ordinario', stato: 'attivo', comune: 'Milano', provincia: 'MI', isa: true, ritenute: false, dipendenti: 0, defaultCasella: 'me' },
  { id: 'c2', ragioneSociale: 'Bianchi SRL', codiceFiscale: '02345678901', partitaIva: '02345678901', email: 'info@bianchi.it', telefono: '06 9876543', tipologiaCliente: 'societa_capitali', categoriaAnagrafica: 'contabilità', regimeFiscale: 'ordinario', stato: 'attivo', comune: 'Roma', provincia: 'RM', isa: false, ritenute: true, dipendenti: 5, defaultCasella: 'info@studiogds.it' },
...
export const CHECKLIST = [
  ...
  // ── 2026 ────────────────────────────────────────────────────────────────────
  { id: 'ch10', clienteId: 'c1', clienteNome: 'Rossi Mario', anno: 2026, categoria: 'IVA', adempimento: 'Liquidazione IVA — I trim.', scadenza: '2026-05-30', stato: 'fatto' },
  ...
  { id: 'ch20', clienteId: 'c2', clienteNome: 'Bianchi SRL', anno: 2026, categoria: 'Societario', adempimento: 'Approvazione bilancio — assemblea soci', scadenza: '2026-04-30', stato: 'fatto' },
  ...
  { id: 'ch22', clienteId: 'c2', clienteNome: 'Bianchi SRL', anno: 2026, categoria: 'Ritenute', adempimento: 'F24 Ritenute — Aprile', scadenza: '2026-05-16', stato: 'fatto' },
  ...
  { id: 'ch24', clienteId: 'c2', clienteNome: 'Bianchi SRL', anno: 2026, categoria: 'Dipendenti', adempimento: 'Busta paga — Maggio', scadenza: '2026-05-31', stato: 'fatto' },
  ...
  { id: 'ch40', clienteId: 'c4', clienteNome: 'Studio Tecnico Neri', anno: 2026, categoria: 'IVA', adempimento: 'Liquidazione IVA — I trim.', scadenza: '2026-05-30', stato: 'fatto' },
  { id: 'ch41', clienteId: 'c4', clienteNome: 'Studio Tecnico Neri', anno: 2026, categoria: 'Ritenute', adempimento: 'F24 Ritenute — Aprile', scadenza: '2026-05-16', stato: 'fatto' },
