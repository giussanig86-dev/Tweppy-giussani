export const CLIENTI = [
  { id: 'c1', ragioneSociale: 'Rossi Mario', codiceFiscale: 'RSSMRA80A01H501U', partitaIva: '12345678901', email: 'mario.rossi@email.it', telefono: '02 1234567', tipologiaCliente: 'persona_fisica', regimeFiscale: 'ordinario', stato: 'attivo', comune: 'Milano', provincia: 'MI', isa: true, ritenute: false, dipendenti: 0 },
  { id: 'c2', ragioneSociale: 'Bianchi SRL', codiceFiscale: '02345678901', partitaIva: '02345678901', email: 'info@bianchi.it', telefono: '06 9876543', tipologiaCliente: 'societa_capitali', regimeFiscale: 'ordinario', stato: 'attivo', comune: 'Roma', provincia: 'RM', isa: false, ritenute: true, dipendenti: 5 },
  { id: 'c3', ragioneSociale: 'Verdi Anna (Forfettario)', codiceFiscale: 'VRDNNA92C55F205K', partitaIva: '98765432109', email: 'anna.verdi@gmail.com', telefono: '339 1111222', tipologiaCliente: 'persona_fisica', regimeFiscale: 'forfettario', stato: 'attivo', comune: 'Napoli', provincia: 'NA', isa: false, ritenute: false, dipendenti: 0 },
  { id: 'c4', ragioneSociale: 'Studio Tecnico Neri', codiceFiscale: '07654321098', partitaIva: '07654321098', email: 'studio@neri.it', telefono: '011 5556666', tipologiaCliente: 'societa_persone', regimeFiscale: 'ordinario', stato: 'attivo', comune: 'Torino', provincia: 'TO', isa: true, ritenute: true, dipendenti: 2 },
  { id: 'c5', ragioneSociale: 'Ferrari Giuseppe', codiceFiscale: 'FRRGPP75D10L219X', partitaIva: '55544433300', email: 'gferrari@libero.it', telefono: '051 2223333', tipologiaCliente: 'persona_fisica', regimeFiscale: 'ordinario', stato: 'inattivo', comune: 'Bologna', provincia: 'BO', isa: false, ritenute: false, dipendenti: 0 },
];
